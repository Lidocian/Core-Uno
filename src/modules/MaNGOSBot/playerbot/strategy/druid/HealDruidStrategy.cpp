...
void HealDruidStrategy::InitTriggers(std::list<TriggerNode*> &triggers)
{
	...
	triggers.push_back(new TriggerNode("almost full health", NextAction::array(0, NextAction("life bloom", ACTION_LIGHT_HEAL), NULL)));
	triggers.push_back(new TriggerNode("almost full health", NextAction::array(0, NextAction("regrowth", ACTION_LIGHT_HEAL + 1), NULL)));
	triggers.push_back(new TriggerNode("almost full health", NextAction::array(0, NextAction("wild growth", ACTION_LIGHT_HEAL + 2), NULL)));
	...
	triggers.push_back(new TriggerNode("party member medium health", NextAction::array(0, NextAction("nourish", ACTION_MEDIUM_HEAL + 1), NULL)));
	...
	triggers.push_back(new TriggerNode("critical health", NextAction::array(0, NextAction("swiftmend", ACTION_CRITICAL_HEAL + 1), NULL)));


	// High health management (Use only HoTs)
	triggers.push_back(new TriggerNode("party member almost full health", NextAction::array(0, NextAction("life bloom on party", ACTION_LIGHT_HEAL), NULL)));
	...
	triggers.push_back(new TriggerNode("party member almost full health", NextAction::array(0, NextAction("wild growth on party", ACTION_LIGHT_HEAL + 2), NULL)));
	...
	triggers.push_back(new TriggerNode("party member medium health", NextAction::array(0, NextAction("nourish on party", ACTION_MEDIUM_HEAL + 1), NULL)));
	...
	triggers.push_back(new TriggerNode("party member critical health", NextAction::array(0, NextAction("swiftmend on party", ACTION_CRITICAL_HEAL + 1), NULL)));
